...
Times available on 03 Oct: %s\n
Times available on 04 Oct: %s\n
...
Comments: %s\n
",$first_name,$last_name,$gender,$church,$college,$department,$year,$email,$phone,$avail_21_Sept,$avail_22_Sept,$avail_23_Sept,$avail_24_Sept,$avail_25_Sept,$avail_26_Sept,$avail_27_Sept,$avail_28_Sept,$avail_29_Sept,$avail_30_Sept,$avail_01_Oct,$avail_02_Oct,$avail_03_Oct,$avail_04_Oct,$duration,$visit,$training,$comments);        
break;
case "arrival":
