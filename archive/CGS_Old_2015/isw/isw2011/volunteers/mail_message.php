...
{
if (strpos($postvar, "avail_") !== false)
{
$date_avl = substr($postvar, 1, 6);
$hour_avl = substr($postvar, 14, 5);
$emailvar = "avail_" . $date_avl;
...
Times available on 01 Octo: %s\n
Times available on 02 Octo: %s\n
Times available on 03 Octo: %s\n
Times available on 04 Octo: %s\n
...
Comments: %s\n
",$first_name,$last_name,$gender,$church,$college,$department,$year,$email,$phone,$avail_21_Sept,$avail_22_Sept,$avail_23_Sept,$avail_24_Sept,$avail_25_Sept,$avail_26_Sept,$avail_27_Sept,$avail_28_Sept,$avail_29_Sept,$avail_30_Sept,$avail_01_Octo,$avail_02_Octo,$avail_03_Octo,$avail_04_Octo,$duration,$visit,$training,$comments);        
break;
case "arrival":
